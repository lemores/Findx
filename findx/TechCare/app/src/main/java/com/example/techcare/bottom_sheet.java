    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(bottom_sheet.this,"You Like the Song",Toast.LENGTH_SHORT).show();
        ...
        dislike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(bottom_sheet.this,"You DisLike the Song",Toast.LENGTH_SHORT).show();
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(bottom_sheet.this,"Song Is now Playing",Toast.LENGTH_SHORT).show();
        ...
        pause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(bottom_sheet.this,"Song is Pause",Toast.LENGTH_SHORT).show();
